...
test.describe('Login Feature', () => {
  ...
  test.describe('Successful Login', () => {
    ...
    test(
      'should display user email on dashboard after login',
      { tag: ['@regression'] },
      async ({ loginPage, dashboardPage }) => {
    ...
    test(
      'should work with remember me checked',
      { tag: ['@regression'] },
      async ({ loginPage, dashboardPage }) => {
  ...
  test.describe('Failed Login', () => {
    ...
    test(
      'should show error with valid email but wrong password',
      { tag: ['@regression'] },
      async ({ loginPage }) => {
  ...
  test.describe('Frontend Validation', () => {
    ...
    test(
      'should not make backend call when form is invalid',
      { tag: ['@regression'] },
  ...
  test.describe('Form Elements', () => {
    test(
      'should have remember me checkbox unchecked by default',
      { tag: ['@regression'] },
      async ({ loginPage }) => {
  ...
  test.describe('Navigation Links', () => {
    ...
    test(
      'should navigate to admin page via nav link',
      { tag: ['@regression'] },
      async ({ loginPage }) => {
    ...
    test(
      'should stay on login page when clicking login nav link',
      { tag: ['@regression'] },
      async ({ loginPage }) => {
  ...
  test.describe('Navigation Visibility', () => {
    test(
      'should show navigation on login page',
      { tag: ['@regression'] },
      async ({ loginPage }) => {
    ...
    test(
      'should show navigation on admin page',
      { tag: ['@regression'] },
      async ({ loginPage, page }) => {
    ...
    test(
      'should NOT show navigation on dashboard page',
      { tag: ['@regression'] },
      async ({ loginPage }) => {
    ...
    test(
      'should NOT show navigation on forgot password page',
      { tag: ['@regression'] },
      async ({ loginPage, page }) => {
  ...
  test.describe('Page Title', () => {
    test(
      'should display "Login" title on login page',
      { tag: ['@regression'] },
      async ({ loginPage }) => {
        await expect(loginPage.pageTitle).toHaveText('Login');
      },
    ...
    test(
      'should display "Admin Login" title on admin page',
      { tag: ['@regression'] },
      async ({ loginPage, page }) => {
        await page.goto(routes.admin);
        await expect(loginPage.pageTitle).toHaveText('Admin Login');
